...
select nombre from paises where nombre like "z%a";
select nombre from paises where nombre like "al_____a";
select nombre from paises where nombre like "P%Al";
select nombre from paises where nombre like "m_____a";
select nombre from paises where nombre like "ar__a";
select nombre from paises where nombre like "m%Q__";
select nombre from paises where nombre like "k%z%" and nombre not like "%z";
select nombre from paises where nombre like "_______________" and nombre not like "c%" and nombre not like "%a";
select weekday("2004-10-05");